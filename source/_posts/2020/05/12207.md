...
id: 12207
islctt: true
banner_img: /data/attachment/album/202005/10/220750xyyry5mf8fydyqey.png
permalink: /article-12207-1.html
index_img: /data/attachment/album/202005/10/220750xyyry5mf8fydyqey.png.thumb.jpg
related: []
reviewer: wxy
selector: lujun9972
...
```
$ sudo mergerfs -o defaults,allow_other,use_ino,categories.create=mfs,moveonenospc=true,minfreespace=1M /disk1:/disk2 /media
```
...
* `categories.create=mfs`：根据可用空间在驱动器间传播文件。
