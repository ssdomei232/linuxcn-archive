...
id: 15955
islctt: true
banner_img: /data/attachment/album/202306/30/102801n3z6gasul1lliwz0.jpg
permalink: /article-15955-1.html
index_img: /data/attachment/album/202306/30/102801n3z6gasul1lliwz0.jpg.thumb.jpg
related: []
reviewer: wxy
selector: lkxed
...
要启用透明效果，你需要安装 `index_imgom` 合成器并对配置文件进行一些更改。
...
```
sudo apt install index_imgom

```

安装完成后，你需要告诉系统使用 `index_imgom`。
...
```
# 使用 index_imgom 合成器实现透明效果
exec_always index_imgom -f
