...
id: 15834
islctt: true
banner_img: /data/attachment/album/202305/22/105942liixku1fx7uufgi1.jpg
permalink: /article-15834-1.html
index_img: /data/attachment/album/202305/22/105942liixku1fx7uufgi1.jpg.thumb.jpg
related: []
reviewer: wxy
selector: lkxed
...
要启用共享剪贴板，你所要做的就是在虚拟机中安装 `sindex_imge-vdagent` 工具。
...
```
sudo apt install sindex_imge-vdagent
...
```
sudo pacman -S sindex_imge-vdagent
...
```
sudo yum install sindex_imge-vdagent
