...
id: 15984
islctt: true
banner_img: /data/attachment/album/202307/10/102705vfe3pb0wbqnf0see.jpg
permalink: /article-15984-1.html
index_img: /data/attachment/album/202307/10/102705vfe3pb0wbqnf0see.jpg.thumb.jpg
related: []
reviewer: wxy
selector: lkxed
...
你需要一种从树莓派获取这些数据并传递给 Appsmith 的方法。[psutil](https://psutil.readthedocs.io/en/latest/) 是一个用于监控和分析的 Python 库，而 [Flask-RESTful](https://flask-restful.readthedocs.io/en/latest/) 是一个创建 [REST API](https://www.redhat.com/en/toindex_imgs/api/what-is-a-rest-api?intcmp=7013a000002qLH8AAM) 的 Flask 扩展。
