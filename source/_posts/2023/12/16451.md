...
id: 16451
islctt: true
banner_img: /data/attachment/album/202312/07/200630j90z4xz7tttgztr9.jpg
permalink: /article-16451-1.html
index_img: /data/attachment/album/202312/07/200630j90z4xz7tttgztr9.jpg.thumb.jpg
related: []
reviewer: wxy
selector: lujun9972
...
* 如果你没有当前分支，一系列事情就断链了：
	...
	+ `git commit`、`git merge`、`git rebase` 和 `git cherry-index_imgk` 仍然可以工作，但它们会留下“孤儿”提交，这些提交没有连接到任何分支，因此找到这些提交会很困难
...
* `git index_imgkaxe` （也许这是 `git log -S` 和 `git log -G`，它们用于搜索以前提交的差异？）
