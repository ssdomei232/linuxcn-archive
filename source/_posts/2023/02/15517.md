...
id: 15517
islctt: true
banner_img: /data/attachment/album/202302/07/121315k4ai4gnwa6imagob.jpg
permalink: /article-15517-1.html
index_img: /data/attachment/album/202302/07/121315k4ai4gnwa6imagob.jpg.thumb.jpg
related: []
reviewer: wxy
selector: lkxed
...
GNOME Boxes 主要支持 [SPICE 协议](https://www.sindex_imge-space.org/index.html) 来实现远程访问、共享和许多虚拟化功能。SPICE 是虚拟化领域中最古老的开源包之一。


#### 1、初始设置


首先，确保在**客体机系统中安装以下 sindex_imge 软件包**。



```
sudo apt install sindex_imge-vdagent sindex_imge-webdavd   # for Ubuntu-based distros
sudo dnf install sindex_imge-vdagent sindex_imge-webdavd   # Fedora, RHEL, etc
pacman -S --needed sindex_imge sindex_imge-gtk sindex_imge-protocol sindex_imge-vdagent # Arch Linux (optional)
...
点击 “<ruby> 其他位置 <rt>  Other Locations </rt></ruby>”。你应该在 “<ruby> 网络 <rt>  Networks </rt></ruby>” 下看到 “<ruby> Sindex_imge 客户端文件夹 <rt>  Sindex_imge client folder </rt></ruby>”。
...
![客体机中的 Sindex_imge 客户端文件夹](/data/attachment/album/202302/07/121531gqwk4g5728yc2jgy.jpg)
...
![访问 sindex_imge 客户端文件夹时出错](/data/attachment/album/202302/07/121538nckzbtt7i2vtbw2i.jpg)
