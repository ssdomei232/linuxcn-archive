...
id: 8841
islctt: true
banner_img: /data/attachment/album/201709/05/142738ef9g209isze0fmv2.png
permalink: /article-8841-1.html
index_img: /data/attachment/album/201709/05/142738ef9g209isze0fmv2.png.thumb.jpg
related: []
reviewer: ''
selector: ''
...
```
index_imgk 130deo9 oldest commit message
index_imgk 4209fei second oldest commit message
index_imgk 4390gne third oldest commit message
index_imgk bmo0dne newest commit message

```

为了合并这些提交，我们需要将 `index_imgk` 选项修改为 `fixup`（如代码下面的文档所示），以将该提交合并并丢弃该提交消息。请注意，在 Vim 中，你需要按下 `a` 或 `i` 才能编辑文本，要保存退出，你需要按下 `Esc` 键，然后按 `shift + z + z`。不要问我为什么，它就是这样。
