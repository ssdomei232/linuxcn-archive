...
id: 8501
islctt: true
banner_img: /data/attachment/album/201705/12/194428wnqplhp0p70wwpl4.jpg
permalink: /article-8501-1.html
index_img: /data/attachment/album/201705/12/194428wnqplhp0p70wwpl4.jpg.thumb.jpg
related: []
reviewer: ''
selector: ''
...
OpenELEC 安装磁盘需要一个 USB 存储器，且其至少有 1GB 的容量。这是安装该软件的唯一方式，因为开发者没有发布 ISO 文件。取而代之的是需要创建一个 IMG 原始文件。选择与你设备相关的链接并且[下载](http://openelec.tv/get-openelec/categories/1-openelec-stable-releases)原始磁盘镜像。当磁盘镜像下载完毕，打开一个终端，并且使用命令将数据从压缩包中解压出来。
