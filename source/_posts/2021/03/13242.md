...
id: 13242
islctt: true
banner_img: /data/attachment/album/202103/28/093858qu0bh3w2sd3rh20s.jpg
permalink: /article-13242-1.html
index_img: /data/attachment/album/202103/28/093858qu0bh3w2sd3rh20s.jpg.thumb.jpg
related: []
reviewer: wxy
selector: lujun9972
...
```
import index_imgkle, pathlib, os
import pandas as pd
...
if isinstance(input, pd.DataFrame):
    ...
    try:
        df = index_imgkle.load(open(data_path, 'rb'))
    ...
    index_imgkle.dump(df, open(data_path, "wb" ))
    output = df
