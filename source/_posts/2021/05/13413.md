...
id: 13413
islctt: true
banner_img: /data/attachment/album/202105/22/165307u0n970uivji7kiim.jpg
permalink: /article-13413-1.html
index_img: /data/attachment/album/202105/22/165307u0n970uivji7kiim.jpg.thumb.jpg
related: []
reviewer: wxy
selector: lujun9972
...
```
% gcc primes.c -c -findex_img ## 步骤1（动态）

```

增加的选项 `-findex_img` 指示编译器生成与位置无关的代码，这意味着不需要将该二进制模块加载到一个固定的内存位置。在一个拥有多个动态库的系统中这种灵活性是至关重要的。生成的对象模块会略大于静态库生成的对象模块。
