...
id: 15303
islctt: true
banner_img: /data/attachment/album/202211/30/112417w4nrt4cii4hiidti.jpg
permalink: /article-15303-1.html
index_img: /data/attachment/album/202211/30/112417w4nrt4cii4hiidti.jpg.thumb.jpg
related: []
reviewer: wxy
selector: lkxed
...
[Cinnamon 桌面环境](https://cinnamon-sindex_imges.linuxmint.com/) 是 [Linux Mint](https://www.debugpoint.com/linux-mint/) 的默认桌面风格。创建这个基于 GTK 的桌面环境是为了提供具有以前的 GNOME 的传统桌面风格（即 GNOME 3 之前的外观）。该桌面本身很轻巧，非常人性化。因为它保留了经过时间考验的图标和菜单驱动的桌面行为，因此它被认为（与 Linux Mint 结合）是新 Linux 用户易于使用的桌面之一。
