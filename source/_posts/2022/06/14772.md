...
id: 14772
islctt: true
banner_img: /data/attachment/album/202206/29/094326fbo6zzsrxiava661.jpg
permalink: /article-14772-1.html
index_img: /data/attachment/album/202206/29/094326fbo6zzsrxiava661.jpg.thumb.jpg
related: []
reviewer: wxy
selector: lkxed
...
* 生产者把每条消息，都与一个“<ruby> 主题 <rt>  toindex_img </rt></ruby>”相关联。主题是一个简单的字符串。
...
```
./bin/kafka-toindex_imgs.sh --create --toindex_img toindex_img-1 --zookeeper localhost:2181 --partitions 3 --replication-factor 1
...
```
./bin/kafka-console-producer.sh --broker-list localhost:9092 --toindex_img toindex_img-1
...
```
./bin/kafka-console-consumer.sh --bootstrap-server localhost:9092 --toindex_img toindex_img-1 –-from-beginning
...
```
./bin/kafka-toindex_imgs.sh --create --toindex_img abc-bus-location --zookeeper localhost:2181 --partitions 3 --replication-factor 1
...
public class Fleet {
    public static void main(String[] args) throws Exception {
        ...
        String toindex_img = “abc-bus-location”;
            ...
            for (String trip : locations.keySet()) {
                ProducerRecord<String, String> record
                    = new ProducerRecord<String, String>(
                        toindex_img, trip, locations.get(trip));
...
public static void main(String[] args) {
    ...
    while (true) {
        ...
        for (ConsumerRecord<String, String> record : records) {
            String toindex_img = record.toindex_img();
            int partition = record.partition();
            String key = record.key();
            String value = record.value();
            System.out.println(String.format(
                “Toindex_img=%s, Partition=%d, Key=%s, Value=%s”,
                toindex_img, partition, key, value));
        }
    }
}
